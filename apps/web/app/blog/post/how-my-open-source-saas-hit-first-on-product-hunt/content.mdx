...
# How My Email Hero hit \#1 on Product Hunt

Two weeks ago I launched My Email Hero on Product Hunt. It finished in first place with over 1,000 upvotes and gained thousands of new users.
...
[My Email Hero](https://myemailhero.com) helps you clean up your inbox fast. It lets you bulk unsubscribe from newsletters, automate emails with an AI assistant, automatically block cold emails, and provides email analytics.
...
Being open source also means anyone can contribute to the project to improve it or fix bugs. My Email Hero already has developers from all over the world contributing to making it better. Top open source projects have hundreds of contributers.
...
Another common concern people have is whether the company will lose revenue to self-hosters. Instead of paying $10 per month to use My Email Hero, you could clone the project for free and self-host. Which would hurt My Email Hero's revenue.

It’s especially bad if you have an expensive product. To save the $10-19 per month fee that My Email Hero charges for the pro version, it might not be worth the effort to self-host. The time it will take you to set it up, and then run the servers yourself, you’re better off paying the monthly subscription. Not to mention 99% of people can’t self-host. You’d need a developer to do it.
...
It did for My Email Hero.

![My Email Hero Growth](/images/blog/inbox-zero-growth.png)

The launch led to My Email Hero being featured in popular newsletters such as Ben’s Bites and The Rundown AI. Newsletters that are read by hundreds of thousands of people.
...
This is the Product Hunt page for My Email Hero for reference as I talk about some of the things I did: [https://www.producthunt.com/products/inbox-zero-2](https://www.producthunt.com/products/inbox-zero-2)
...
Product Hunt has said you no longer need a hunter. But I made sure to have one. The Product Hunt team doesn't feature every product that launches on the homepage. So I felt adding a hunter would give me a better chance of the PH team selecting My Email Hero to be featured. It also adds some legitimacy to the launch.
...
If you enjoyed this article, be sure to try [My Email Hero](https://myemailhero.com) to automate your email and clean up your inbox.
